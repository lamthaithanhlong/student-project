...
values ((SELECT id from users where id = 1), (SELECT id from roles where id = 1));

INSERT INTO user_role (user_id, role_id)
values ((SELECT id from users where id = 2), (SELECT id from roles where id = 1));
...
VALUES ('company','', '',
           (SELECT id from address where id = 1), (SELECT id from users where id = 1), 'Blue Sky Realty', '941-234-3423', 'Blue Sky Realty');

INSERT INTO legal_entity (legal_entity_type, first_name, last_name, address_id, user_id, legal_entity_name,phone_number, company_name)
VALUES ( 'person', 'Noah', 'Johns', (SELECT id from address where id = 2), (SELECT id from users where id = 1) , 'Noah Johns', '441-234-9823', '');

INSERT INTO legal_entity ( legal_entity_type, first_name, last_name, address_id, user_id, legal_entity_name,phone_number, company_name)
VALUES ( 'company', '', '', (SELECT id from address where id = 3), (SELECT id from users where id = 2), 'Landmark Realty Group', '441-234-2345', 'Landmark Realty Group');
